...
class DQNAgent:
	def __init__(self, action_size, stone_name):		
		...
		if self.load_model and stone_name == "black":
			self.model.load_weights("./save_model/omok_black_v0.2.h5")
		elif self.load_model and stone_name == "white":
			self.model.load_weights("./save_model/omok_white_v0.2.h5")
	...
	def get_action(self, history):
		...
		if np.random.rand() <= self.epsilon:
			while True:
				_x = random.randrange(8)+random.randrange(8)
				_y = random.randrange(8)+random.randrange(8)
...
if __name__ == "__main__":
	...
	for e in range(EPISODES):
		...
		if e % 100 == 0:
			...
			now = now1
			agent[1].model.save_weights("./save_model/omok_black_v0.2.h5")
			agent[0].model.save_weights("./save_model/omok_white_v0.2.h5")
